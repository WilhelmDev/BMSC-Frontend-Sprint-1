...
import {
  ACCOUNTS_COMPARATOR_KEY,
  CATEGORIES,
  INSURANCE_COMPARATOR_KEY,
  ITEMS,
  SECTIONS
} from "~/cardListKeys/comparators";
...
export default {
  ...
  async asyncData(context) {
    ...
    await context.store.dispatch(`comparators/${UPDATE_STATE_ACTION}`,INSURANCE_COMPARATOR_KEY);
    return header;
  },
