...
export default {
  ...
  async mounted() {
    await this.$store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_TITLE);
    await this.$store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_PROGRAMS);
    await this.$store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_VIDEO_HEADER);
    await this.$store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_VIDEO_CARDS);
  },
  computed: {
    titleData: function () {
      let res = {
        items: this.$store.getters["tech/getList"](TECH_ATMS_TITLE)
      }
    ...
    programsData: function () {
      let sectionList = this.$store.getters["tech/getList"](TECH_ATMS_PROGRAMS);
      let res = {
        items: sectionList
      }
    ...
    videoHeaderData: function () {
      let sectionList = this.$store.getters["tech/getList"](TECH_ATMS_VIDEO_HEADER);
    ...
    videosData: function () {
      let sectionList = this.$store.getters["tech/getList"](TECH_ATMS_VIDEO_CARDS);
      const fallback = [
        {
  ...
  async asyncData(context) {
    ...
    await context.store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_TITLE);
    await context.store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_PROGRAMS);
    await context.store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_VIDEO_HEADER);
    await context.store.dispatch(`tech/${UPDATE_STATE_ACTION}`, TECH_ATMS_VIDEO_CARDS);
    return header;
  },
