...
export default {
  ...
  data() {
    return {
      ...
      compareConfig: {
        items: [{
          title:
            "¿Estás listo para tu <span class='green-md-text'>Préstamo de vivienda social</span>?",
          description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.",
          buttonName: "Ir al simulador pe"
        }]
      },
      listItems: [
        {
  ...
  methods: {
    ...
    async loadLoanDetailsData() {
      await this.$store.dispatch(`loanDetailsBanx/${UPDATE_STATE_ACTION}`, [this.loanKey, TITLE, this]);
      await this.$store.dispatch(`loanDetailsBanx/${UPDATE_STATE_ACTION}`, [this.loanKey, INTERESTS_RATE, this]);
      await this.$store.dispatch(`loanDetailsBanx/${UPDATE_STATE_ACTION}`, [this.loanKey, DESCRIPTION, this]);
      await this.$store.dispatch(`loanDetailsBanx/${UPDATE_STATE_ACTION}`, [this.loanKey, BENEFITS, this]);
      await this.$store.dispatch(`loanDetailsBanx/${UPDATE_STATE_ACTION}`, [this.loanKey, INFORMATION_PANEL, this]);
      await this.$store.dispatch(`loanDetailsBanx/${UPDATE_STATE_ACTION}`, [this.loanKey, COMPARE, this]);
    },
    goToHref(item) {
  ...
  computed: {
    ...
    titleData: function () {
      let res = {
        items: this.$store.getters["loanDetailsBanx/getList"](TITLE)
      }
    ...
    interestsRateData: function () {
      let res = {
        items: this.$store.getters["loanDetailsBanx/getList"](INTERESTS_RATE)
      }
    ...
    descriptionData: function () {
      let res = {
        items: this.$store.getters["loanDetailsBanx/getList"](DESCRIPTION)
      }
    ...
    benefitsData: function () {
      let sectionList = this.$store.getters["loanDetailsBanx/getList"](BENEFITS);
    ...
    informationPanelData: function () {
      let res = {
        items: this.$store.getters["loanDetailsBanx/getList"](INFORMATION_PANEL)
      }
      // needed fallback
    ...
    compareData: function () {
      let res = {
        items: this.$store.getters["loanDetailsBanx/getList"](COMPARE)
      }
    ...
    relatedPanelMap: function () {
      switch (this.loanKey) {
        ...
        case 'Vivienda-BANX-detalle':
          return [
            {
              title: "Vivienda Social",
              subTitle: "Ver opciones",
              route: "/loanDetailsBanx?key=Vivienda-interes-Social-detalle"
            },
            {
              title: "Vehículo BANX",
              subTitle: "Ver opciones",
              route: "/loanDetailsBanx?key=Vehiculo-BANX-detalle"
            },
            {
              title: "Consumo BANX",
              subTitle: "Ver opciones",
              route: "/loanDetailsBanx?key=Consumo-BANX-detalle"
            },
            {
              title: "Credito consumo planilla",
              subTitle: "Ver opciones",
        ...
        case 'Vivienda-interes-Social-detalle':
          return [
            {
              title: "Compra de vivienda",
              subTitle: "Ver opciones",
              route: "/loanDetailsBanx?key=Vivienda-BANX-detalle"
            },
            {
              title: "Vehículo BANX",
              subTitle: "Ver opciones",
