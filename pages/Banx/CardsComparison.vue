...
import {CATEGORIES, CREDIT_CARD_BANX_COMPARATOR_KEY, ITEMS, SECTIONS} from "~/cardListKeys/comparators";
...
export default {
  ...
  async asyncData(context) {
    ...
    await context.store.dispatch(`comparators/${UPDATE_STATE_ACTION}`,CREDIT_CARD_BANX_COMPARATOR_KEY);
    return header;
  },
