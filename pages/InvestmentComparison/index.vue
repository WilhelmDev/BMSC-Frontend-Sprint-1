...
import {CATEGORIES, INVESTMENT_COMPARATOR_KEY, ITEMS, SECTIONS} from "~/cardListKeys/comparators";
...
export default {
  ...
  data: () => {
    return {
      title: "Comparador de cuentas de inversión",
  ...
  async asyncData(context) {
    ...
    await context.store.dispatch(`comparators/${UPDATE_STATE_ACTION}`,INVESTMENT_COMPARATOR_KEY);
    return header;
  },
