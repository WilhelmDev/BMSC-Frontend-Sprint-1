...
import {CATEGORIES, ITEMS, LOAN_BANX_COMPARATOR_KEY, SECTIONS} from "~/cardListKeys/comparators";
...
export default {
  ...
  async asyncData(context) {
    ...
    await context.store.dispatch(`comparators/${UPDATE_STATE_ACTION}`,LOAN_BANX_COMPARATOR_KEY);
    return header;
  },
