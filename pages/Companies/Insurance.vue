...
import {
  ...
  INSURANCE_TITLE,
  INSURANCE_COMPARE, LOANS_COMPARE
...
export default {
  ...
  computed: {
    titleData: function () {
      let res = {
        items: this.$store.getters["companies/getList"](INSURANCE_TITLE)
      }
    ...
    cardsData: function () {
      let res = {
        items: this.$store.getters["companies/getList"](INSURANCE_CARDS)
      }
    ...
    reviewsData: function () {
      let res = {
        items: this.$store.getters["companies/getList"](INSURANCE_REVIEWS_CAROUSEL)
      }
      //console.log(INSURANCE_REVIEWS_CAROUSEL, res);
      return res;
    },
    benefitsData: function () {
      let sectionList = this.$store.getters["companies/getList"](INSURANCE_BENEFITS);
    ...
    programsData: function () {
      let sectionList = this.$store.getters["companies/getList"](INSURANCE_PROGRAMS);
    ...
    benefits2Data: function () {
      let sectionList = this.$store.getters["companies/getList"](INSURANCE_BENEFITS_2);
      if(sectionList.length === 0) sectionList = generateEmptyModels(1);
    ...
    selectedCards() {
      const cards = this.cardsData.items;
      return cards;
    },
    compareData: function () {
      return {
        items: this.$store.getters["companies/getList"](INSURANCE_COMPARE)
      }
    },
  ...
  async asyncData(context) {
    ...
    await context.store.dispatch(`companies/${UPDATE_STATE_ACTION}`,INSURANCE_TITLE);
    await context.store.dispatch(`companies/${UPDATE_STATE_ACTION}`,INSURANCE_CARDS);
    await context.store.dispatch(`companies/${UPDATE_STATE_ACTION}`,INSURANCE_REVIEWS_CAROUSEL);
    await context.store.dispatch(`companies/${UPDATE_STATE_ACTION}`,INSURANCE_BENEFITS);
    await context.store.dispatch(`companies/${UPDATE_STATE_ACTION}`,INSURANCE_PROGRAMS);
    await context.store.dispatch(`companies/${UPDATE_STATE_ACTION}`,INSURANCE_BENEFITS_2);
    await context.store.dispatch(`companies/${UPDATE_STATE_ACTION}`, INSURANCE_COMPARE);
    return header;
  },
